...
{
	public abstract class Pooled_BehaviourUnit : BaseBehaviour, Pool_Unit
	{
		//单元状态对象
		protected Pool_UnitState m_unitState = new Pool_UnitState();
		//父列表对象
		Pool_UnitList<Pooled_BehaviourUnit> m_parentList;
		/// <summary>
		...
		{
			m_parentList = parentList as Pool_UnitList<Pooled_BehaviourUnit>;
		}
		/// <summary>
		/// 归还自己，即将自己回收以便再利用
		/// </summary>
