...
namespace Stone.Comp
{
	...
	{
		private static Dictionary<string, BaseBehaviour> m_singletons = new Dictionary<string, BaseBehaviour>();
		public static T Get<T>(string name) where T:BaseBehaviour
		{

			BaseBehaviour singleton = null;
